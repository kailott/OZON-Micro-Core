#include <stddef.h> //needed for long
...
bool dmalloc_init(unsigned int heap_region) {
	/* Two choices:
	...
	blocks[9] = (metadata_t*) heap_region; // returns heap_region, which is initialized to freelist
